...
bool Commandes::isID_COMMANDEUnique(int ID_COMMANDE)
{
    QSqlQuery query;
    query.prepare("SELECT COUNT(*) FROM commandes WHERE ID_COMMANDE = :ID_COMMANDE");
...
bool Commandes::isValidDateCommande(const QString& dateString) {
...
bool Commandes::supprimerCommande(int ID_COMMANDE)
{
    QSqlQuery query;
...
QSqlQueryModel* Commandes::chercherCommande(int ID_COMMANDE)
{
    QSqlQueryModel* model = new QSqlQueryModel();
